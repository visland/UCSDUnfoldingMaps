...
public class AirportMap extends PApplet {
  ...
  public void mouseClicked() {
    if (lastClicked != null) {
      ...
      clickOnAirport(airportList);
    }
  }

  public void clickOnAirport(List<Marker> markers) {
    if (lastClicked != null) {
      return;
    }
    for (Marker mk : markers) {
      if (lastClicked == null && mk.isInside(map, mouseX, mouseY)) {
        ...
        for (Marker route : routeList) {
          if ((route.getProperty("source")).equals(mk.getId()) || (route.getProperty("destination")).equals(mk.getId())) {
